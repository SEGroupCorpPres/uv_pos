...
sealed class AppColors {
  ...
  static const Color mainBG = Color(0xFF1A1A1A);
  static const Color bottomNavBarBg = Color(0xFF0F0F0F);
  static const Color mainScaffoldBG = Color(0xFF000000);
  static const Color mainText = Color(0xFFFFFFFF);
  static const Color inactiveText = Color(0xFF808080);
  static const LinearGradient premiumGradient = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
    colors: [Color(0xFFB88E50), Color(0xFFFAF5A3), Color(0xFFE4AA47), Color(0xFFFAF493)],
  );
  static const LinearGradient standardGradient = LinearGradient(
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
    colors: [Color(0xFFFFFFFF), Color(0xFF9C9C9C), Color(0xFFFFFFFF), Color(0xFF9C9C9C)],
  );
}
