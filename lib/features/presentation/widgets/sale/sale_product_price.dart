        ...
        children: [
          Flexible(
            ...
            child: Text(
              title,
              style:
                  TextStyle(color: fontColor, fontSize: fontSize!.sp, fontWeight: FontWeight.w600),
              textAlign: textAlign,
            ),
          ),
          procedure == null
              ? Flexible(
                  ...
                  child: Text(
                    price!,
                    style: TextStyle(
                        color: fontColor, fontSize: fontSize!.sp, fontWeight: FontWeight.w600),
              ...
              : Flexible(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                        color: Colors.black, fontSize: fontSize!.sp, fontWeight: FontWeight.w600),
                    textAlign: TextAlign.right,
                  ),
                ),
        ],
