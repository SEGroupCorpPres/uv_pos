...
// import '../../../presentation/pages/sale/sale.dart';
...
//   final TextEditingController _productQtyController =
...
//     final barcodeType = type == 'barcode'
...
//   void _showChangeProductQtyDialog(
//       BuildContext context, OrderProductModel orderProduct) {
...
//                       style: TextStyle(
//                           color: value ? Colors.white : Colors.deepPurple),
//                     ),
//                   ),
//                 );
//               },
...
//                 BlocProvider.of<OrderBloc>(context).add(OrderDiscountedEvent(
//                     discount: discount, isFlat: isFlat.value));
//                 if (kDebugMode) {
...
//   Widget _changeProductQtyDialog(
//       BuildContext context, OrderProductModel orderProduct) {
...
//                                 (int.tryParse(_productQtyController.text)! - 1)
//                                     .toString();
//                           });
//                         }
//                       },
...
//                       .add(RemoveProduct(orderProduct.id));
//                 }
//                 Navigator.pop(context);
//               },
//               style: ElevatedButton.styleFrom(backgroundColor: Colors.green),
...
//                 IconButton(
//                   onPressed: () {
//                     BlocProvider.of<ProductBloc>(context).add(FilterProductList(
//                         storeID: appState.storeID!, filter: ''));
...
//                               context, productState, products, appState);
//                         },

//                         child: BlocConsumer<OrderBloc, OrderState>(
//                           listener: (context, orderState) {
//                             _orderBlocListener(
//                                 context, orderState, products, appState);
//                           },
...
//                                         ? orderState.products!
//                                         : [];
//                             return buildSaleButtons(
//                                 size, context, appState, products);
//                           } else {
//                             return buildSaleButtons(
//                                 size, context, appState, products);
//                           }
...
//                                   .toStringAsFixed(3))
//                           : 0,
//                   discountingPrice: formatAmount
//                       .format(orderSubTotalAmount - orderTotalAmount),
//                 ),
//                 SaleProductPrice(
//                     title: 'Total',
...
//                         _showPayingDialog(context, appState.userID!,
//                             appState.storeID!, products);
//                       }
//                       if (kDebugMode) {
...
//               title: 'Discount',
//               price:
//                   formatAmount.format(orderSubTotalAmount - orderTotalAmount),
//               textAlign: TextAlign.start,
//             ),
//             SaleProductPrice(
//               title: 'Total',
...
//                     'INV${createdTime.microsecondsSinceEpoch.toString()}',
//                     'barcode');
//                 orderQrcode = generateBarcode(order.toString(), 'qrcode');
//                 order =
//                     order.copyWith(barcode: orderBarcode, qrcode: orderQrcode);
//                 if (kDebugMode) {
//                   log('order is $order');
//                 }
...
//                       .add(UpdateStockEvent(stock: stock, storeID: storeID));
//                 }
//                 Navigator.pop(context);
//                 BlocProvider.of<OrderBloc>(context).add(
...
//   void _showSuccessFullDialog(BuildContext context, UserModel employee,
//       StoreModel store, OrderModel order) {
//     showAdaptiveDialog(
//       context: context,
//       builder: (context) {
...
//   SimpleDialog _buildSuccessFullDialogWidget(BuildContext context,
//       UserModel? employee, StoreModel? store, OrderModel order) {
