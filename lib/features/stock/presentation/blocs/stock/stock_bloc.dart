...
//   Future<void> _onFetchStock(
//       FetchStockByStoreId event, Emitter<StockState> emit) async {
//     emit(StockLoading());
//     try {
...
//   Future<void> _updatedStocks(
//       _StockUpdatedEvent event, Emitter<StockState> emit) async {
...
//       UpdateStockEvent event, Emitter<StockState> emit) async {
//     try {
